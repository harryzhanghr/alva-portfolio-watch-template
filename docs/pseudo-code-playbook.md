...
1. `rawEvents[]`: source records fetched from per-holding event sources, technical analysis, and Pi event search, including `technical_event`, `breaking_news`, `theme_news`, and Pi-mapped `topic_news`.
