...
function buildAnalystPrompt(input) {
  ...
  return [
    ...
    "- For multiple selected findings, use real newlines and '- ' bullets. Use one bullet per selected event_impact or anomaly_attribution finding. Each bullet should be self-contained: event/anomaly, insight, portfolio relevance, thesis/risk read, and watchpoint. Each event bullet should carry its own source link when available.",
